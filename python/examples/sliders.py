...
class Window(tgUIApp.Window):
    def __init__(self, context, name, size):
        ...
        groupBox = tgUI.GroupBox(context, "Integer sliders", self.layout);
        ...
        groupBox = tgUI.GroupBox(context, "Float sliders", self.layout);
        vLayout = tgUI.VerticalLayout(context, groupBox)
        ...
        groupBox = tgUI.GroupBox(context, "Double sliders", self.layout);
        vLayout = tgUI.VerticalLayout(context, groupBox)
