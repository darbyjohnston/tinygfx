    ...
    namespace examples
    {
        namespace charts
        {
                ...
                const Size2I& size)
            {
                ...
                pieChart->setData(
                    {
                        PieChartData("Red", 100.F / 3.F, Color4F(1.F, .3F, .3F)),
                        PieChartData("Green", 100.F / 3.F, Color4F(.3F, 1.F, .3F)),
                        PieChartData("Blue", 100.F / 3.F, Color4F(.3F, .3F, 1.F))
                    });
                scrollLayout->setGridPos(pieChart, 0, 0);
                pieChart = PieChart::create(context, scrollLayout);
                pieChart->setData(
                    {
                        PieChartData("Cyan", 25.F, Color4F(.3F, 1.F, 1.F)),
                        PieChartData("Magenta", 25.F, Color4F(1.F, .3F, 1.F)),
                        PieChartData("Yellow", 25.F, Color4F(1.F, 1.F, .3F)),
                        PieChartData("Key", 25.F, Color4F(.3F, .3F, .3F))
                    });
                scrollLayout->setGridPos(pieChart, 0, 1);
                pieChart = PieChart::create(context, scrollLayout);
                pieChart->setData(
                    {
                        PieChartData("Kiwis", 40.F, Color4F(.3F, 1.F, .3F)),
                        PieChartData("Apples", 30.F, Color4F(1.F, .3F, .3F)),
                        PieChartData("Grapes", 15.F, Color4F(1.F, .3F, 1.F)),
                        PieChartData("Bananas", 10.F, Color4F(1.F, 1.F, .3F)),
                        PieChartData("Pears", 5.F, Color4F(.3F, 1.F, 1.F))
                    });
